class LotteriesController < ApplicationController
  ...
  private
    ...
    def lottery_params
      params.require(:lottery).permit(:initial_balance, :rules, :description, :game_id, :game2_id, :winner_number, :initial_number, :final_number, :to_mainpage , :price, :purchase_gift_tickets)
    end
end
