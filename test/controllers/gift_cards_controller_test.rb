...
class GiftCardsControllerTest < ActionController::TestCase
  ...
  test "should create gift_card" do
    assert_difference('GiftCard.count') do
      post :create, gift_card: { available: @gift_card.available, code: @gift_card.code, user_id: @gift_card.user_id, value: @gift_card.value }
    end
  ...
  test "should update gift_card" do
    patch :update, id: @gift_card, gift_card: { available: @gift_card.available, code: @gift_card.code, user_id: @gift_card.user_id, value: @gift_card.value }
    assert_redirected_to gift_card_path(assigns(:gift_card))
  end
